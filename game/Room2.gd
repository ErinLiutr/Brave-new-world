...
var second_scene = preload("res://2ndfloor.tscn")
var base_scene = preload("res://Basement.tscn")
...
func _upstairs(pos):
	...
	var next_scene
	if second_inst == null:
		second_inst = second_scene.instance()
	next_scene = second_inst
	next_scene.title_scene = title_scene
	next_scene.room_inst = this_scene
	...
	next_scene.get_node("YSort/Player").position = Vector2(40 + pos * 16, 104)
...
func _downstairs(ending = null):
	...
	var next_scene
	if base_inst == null:
		base_inst = base_scene.instance()
	next_scene = base_inst
	next_scene.title_scene = title_scene
